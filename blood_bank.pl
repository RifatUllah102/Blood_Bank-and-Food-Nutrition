...
carbohydrate(fish_curry,0).
carbohydrate(fride_chicken,1.8).
carbohydrate(hamburger,24).
carbohydrate(pizza,33).
carbohydrate(beef_curry,18.7).
carbohydrate(chicken_curry,16).
carbohydrate(chicken_biryani,81).
carbohydrate(chicken_roast,0).
carbohydrate(dried_fish,0).
...
carbohydrate(rice,28).
carbohydrate(meat,0).
carbohydrate(fish,0).
carbohydrate(egg,1.1).
carbohydrate(milk,5).
carbohydrate(vegetables,13).
carbohydrate(chicken,0).
carbohydrate(beef,0).
carbohydrate(mushroom,3.3).
carbohydrate(pea,14).
...
body:-
	...
	write('Press 2 for Blood Bank Location List.'),nl,
	write('Press 3 for Food Nutrition Facts.'),nl,
